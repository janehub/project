...
// 	frm.submit();
	window.open('./searchId.do','a', 'width=500px, height=330px');
}
...
<body>
	<div id='title'><h1>KKOKIO 육계관리 사이트</h1></div>
	<div id='container'>
	
<!-- 			<div id='id' style="color: #b0b0b0;">아이디</div> -->
		
		<form method='post' id='frm'>
		
			<input type='hidden' id='loginChk' name='auth' value='0'/>
			<input autocomplete="off" type='text' name='id' id='inputId' placeholder="아이디를 입력해주세요" required='required' style="border: none;">
			<hr>
				<br/>
<!-- 			<div id='pw' style="color: #b0b0b0;">비밀번호</div> -->
			
			<input autocomplete="off" type='password' name='pw' id='inputPw' placeholder="비밀번호를 입력해주세요" required ='required' style="border: none;">
			<hr>
	...
	<div class="footer">
		<p>&copy; 2018 KKOKKIO Login Form. All rights reserved | Design by <a href="#">KKOKKIO</a></p>
	</div>
</body>
</html>